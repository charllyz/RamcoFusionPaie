...
class PrintPayrollAnnuelReport(models.TransientModel):
    _name = 'print.paieannuel.report'
    _description = "Assistant d'impression du livre de paie annuel"
    ...
    def print_report(self):
        ...
        head_ids = []
        for rule in self.env['hr.salary.rule'].search([('struct_id', '=', selected_structure.id)]):
